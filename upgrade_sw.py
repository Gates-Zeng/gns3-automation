...
while i < len(node_list):
    ...
    upgrade_sw(gns3_ip, project_name, sw_ip, node_list[i], 'voss', 'VOSS1K.91.18.1.0int044.tgz')
    i += 1
...
while i < len(node_list):
    ...
    sw_ip = '192.168.255.' + node_list[i].split('-',1)[1]
    print('switch_ip:', sw_ip)
    cleanup_sw(gns3_ip, project_name, node_list[i], 'voss', 'VOSS1K.91.18.1.0int044')
    i += 1
